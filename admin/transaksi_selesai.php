...
$detail = mysqli_query($koneksi, "SELECT transaksi_detail.*, produk.NamaProduk FROM `transaksi_detail` INNER JOIN produk ON transaksi_detail.ProdukID = produk.ProdukID WHERE transaksi_detail.id_transaksi='$id_trx'");
...
<body onload="window.print(); self.close();">
    <div align="center">
        <table width="500" border="0" cellpadding="1" cellspacing="0">
            ...
            <tr>
                <td>#<?= $trx['nomor'] ?> | <?= date('d-m-Y H:i:s', strtotime($trx['tanggal_waktu'])) ?> Kasir Cihuyyy</td>
            </tr>
            <tr>
                <td>
                    <hr>
