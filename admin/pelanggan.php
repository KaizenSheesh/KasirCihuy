...
<body>
                ...
                <form action="../pelanggan_function/pelanggan_insert.php" method="POST">
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="NamaPelanggan" id="exampleFormControlInput1" placeholder="Masukkan nama member">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" name="NomorTelepon" id="exampleFormControlInput3" placeholder="Masukkan nomor telepon member">
                        </div>
                    </div>
        ...
        <tbody>
            <?php foreach ($query as $data) : ?>
                <tr>
                    ...
                    <td>
                        <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" href="../pelanggan_function/pelanggan-delete.php?PelangganID=<?= $data['PelangganID'] ?>" class="btn btn-danger">Delete</a>
                        <button href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal<?= $data['PelangganID'] ?>">Edit</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <?php foreach ($query as $data) : ?>
        <div class="modal fade" id="editModal<?= $data['PelangganID'] ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $data['PelangganID'] ?>" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
